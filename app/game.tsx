...
const NPCS:Npc[] = [
  {id:"reed",name:"Reed",map:5,x:760,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    ...
    againTalk:[{speaker:"Reed",text:"Still walking, Moon Night. The heart is east. Don't go in cold."},{speaker:"Reed",text:"Bind a lynx if you haven't. The east gate heals you. Press E at the heart altar. That ends the campaign."}],
    afterCaptureTalk:[
  ...
  {id:"kest",name:"Kest",map:6,x:920,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Kest",text:"The animals are the echo. Bind the wyrm, then go east. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}
    ],
    againTalk:[{speaker:"Kest",text:"I'm still here. The wyrm hunts farther in. I'm not leaving you to it."},{speaker:"Kest",text:"Bind the wyrm. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}],
    afterCaptureTalk:[
  ...
  {id:"calen",name:"Calen",map:1,x:820,talkRadius:150,cardId:BABY_DRAGON_CARD.id,helm:true,
    firstTalk:[
      ...
      {speaker:"Calen",text:"Bind it, then go east. The east portal heals you. If it falls, press E, then Q. I'll still be here if you walk back."}
    ],
    ...
    afterCaptureTalk:[
      ...
      {speaker:"Calen",text:"Carry it. If the spark stays in the ruins, the rest of the road goes dark. The east portal heals you."},
  ...
  {id:"calen",name:"Calen",map:4,x:3180,talkRadius:150,cardId:PALE_STAG_CARD.id,helm:true,
    firstTalk:[
      ...
      {speaker:"Calen",text:"Aye. Pale antlers, not a castle dragon. The animals are the echo. The well is trying to bottle what you already carry."},
    ...
    againTalk:[
      ...
      {speaker:"Calen",text:"Bind the stag if you haven't, then go east. The east gate heals you. I keep the road behind you."}
    ],
    afterCaptureTalk:[
      ...
      {speaker:"Calen",text:"Tell him a castle knight still stands."}
    ],
    palette:{skin:"#c9b08a",cloak:"#2a3348",trim:"#8aa4c8",accent:"#c8e4ff"}
  },
  {id:"sera",name:"Sera",map:2,x:480,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    ...
    againTalk:[{speaker:"Sera",text:"Still here, Moon Night. Bind a jackal if you haven't, then go east. The east portal heals you."},{speaker:"Sera",text:"A drowned post stands mid-beach. Three scratches. That's the pack, and the call."}],
    afterCaptureTalk:[
  ...
  {id:"sera",name:"Sera",map:5,x:5720,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Sera",text:"He does. The lynx wear coal pelts — tufted ears, bobbed tails. Not jackals. Don't go in cold."},
      {speaker:"Sera",text:"The animals are the echo. Bind one, then go east. The east gate heals you. Press E at the heart altar. That ends the campaign."}
    ],
    againTalk:[
      {speaker:"Sera",text:"We keep crossing roads. Reed is west. The heart is east. Don't go in cold."},
      {speaker:"Sera",text:"The east gate heals you. Talk to Kest. Press E at the altar. That ends it."}
    ],
    afterCaptureTalk:[
      ...
      {speaker:"Sera",text:"The east gate heals you. Heart is through. Talk to Kest. Press E at the altar to end the campaign."},
  ...
  {id:"bram",name:"Bram",map:6,x:1480,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Bram",text:"The animals are the echo. Bind the wyrm, then go east. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"orrin",name:"Orrin",map:1,x:2280,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Orrin",text:"Bind the dragon, then go east. The east portal heals you. The rain still writes after that. The road just has a name walking it."}
    ],
    againTalk:[{speaker:"Orrin",text:"Still copying, Moon Night. Bind the dragon if you haven't, then go east. The east portal heals you."},{speaker:"Orrin",text:"The plaque higher up says the same thing in older stone. The well is farther east."}],
    afterCaptureTalk:[
      {speaker:"Orrin",text:"You took the first spark. The rain I copy is quieter now."},
      {speaker:"Orrin",text:"The east portal heals you. If the well still pools light, I'll meet you there. I want the same line in moonwater."}
    ],
  ...
  {id:"orrin",name:"Orrin",map:4,x:650,talkRadius:150,cardId:PALE_STAG_CARD.id,
    firstTalk:[
      ...
      {speaker:"Orrin",text:"Bind the stag, then go east. The east gate heals you. Calen keeps the later watch. I keep the words so the well does not lie."}
    ],
    againTalk:[{speaker:"Orrin",text:"We meet again. Castle rain, then cliff wind. Same road."},{speaker:"Orrin",text:"Bind the stag if you haven't, then go east. The east gate heals you. The well still tries to bottle what you already carry."}],
    afterCaptureTalk:[
  ...
  {id:"nia",name:"Nia",map:2,x:4360,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    firstTalk:[
      ...
      {speaker:"Nia",text:"Bind one shard, then go east. The east portal heals you. Leave the rest to the sand. The hollow waits when the light fails."}
    ],
    ...
    afterCaptureTalk:[
      ...
      {speaker:"Nia",text:"The east portal heals you. I walk when the light dies. If the heart still beats, we may share that last road."}
    ],
  ...
  {id:"nia",name:"Nia",map:6,x:3280,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Nia",text:"The animals are the echo. Bind the wyrm, then go east. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"vess",name:"Vess",map:5,x:2960,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Vess",text:"The animals are the echo. Bind one, then go east. The east gate heals you. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"tamsin",name:"Tamsin",map:1,x:3980,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Tamsin",text:"Then you heard Calen. I keep the last merlon so nobody mistakes the wall for the call. The animals are the echo."},
  ...
  {id:"tamsin",name:"Tamsin",map:5,x:5000,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"Reed keeps the fire."},
      {speaker:"Tamsin",text:"He does. Lynx-shaped coals, not castle rain. Don't go into the heart cold."},
      {speaker:"Tamsin",text:"The animals are the echo. Bind one, then go east. The east gate heals you. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"lira",name:"Lira",map:4,x:4480,talkRadius:150,cardId:PALE_STAG_CARD.id,
    ...
    againTalk:[{speaker:"Lira",text:"We meet again. Shore dusk, then cliff wind. Same count, later light."},{speaker:"Lira",text:"Bind the stag if you haven't, then go east. The east gate heals you. Don't go into the heart without that heat."}],
    afterCaptureTalk:[
  ...
  {id:"holt",name:"Holt",map:3,x:3800,talkRadius:150,cardId:CINDER_FOX_CARD.id,
    ...
    againTalk:[{speaker:"Holt",text:"Still on the cairn road, Moon Night. Bind leftover heat if you haven't, then go east. The east portal heals you."},{speaker:"Holt",text:"If you skipped the split cairn, walk west. That twist is the road."}],
    afterCaptureTalk:[
  ...
  {id:"holt",name:"Holt",map:6,x:3580,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Holt",text:"The animals are the echo. Bind the wyrm, then go east. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"maer",name:"Maer",map:1,x:5480,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"The spark is in the dragon, not the stone."},
      {speaker:"Maer",text:"Then you heard Calen and Tamsin. I keep the stretch after the merlon so nobody turns back. The animals are the echo."},
      {speaker:"Maer",text:"Bind the first spark, then go east. The east portal heals you. The shore is longer than this rain looks."}
    ],
    againTalk:[{speaker:"Maer",text:"Still on the leftover road, Moon Night. Bind the spark if you haven't, then go east. The east portal heals you."},{speaker:"Maer",text:"The merlon is west if the rain feels thin. The dragon still keeps the ruins."}],
    afterCaptureTalk:[
  ...
  {id:"maer",name:"Maer",map:5,x:3600,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"Reed keeps the fire."},
      {speaker:"Maer",text:"He does. Lynx-shaped coals, not castle rain. Don't go into the heart cold."},
      {speaker:"Maer",text:"The animals are the echo. Bind one, then go east. The east gate heals you. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"perrin",name:"Perrin",map:5,x:3260,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"Reed keeps the kiln."},
      {speaker:"Perrin",text:"He does. Lynx-shaped coals, not dusk fur. Don't go into the heart cold."},
      {speaker:"Perrin",text:"The animals are the echo. Bind one, then go east. The east gate heals you. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"wren",name:"Wren",map:1,x:1200,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    ...
    againTalk:[{speaker:"Wren",text:"Still listening, Moon Night. Bind the spark if you haven't, then go east. The east portal heals you."},{speaker:"Wren",text:"There is a rain-cut groove farther along the floor if the signal feels thin."}],
    afterCaptureTalk:[
  ...
  {id:"wren",name:"Wren",map:4,x:5200,talkRadius:150,cardId:PALE_STAG_CARD.id,
    ...
    againTalk:[{speaker:"Wren",text:"We meet again. Castle rain, then this cliff. Same listen, later wind."},{speaker:"Wren",text:"Bind the stag if you haven't, then go east. The east gate heals you. Don't go into the heart without that heat."}],
    afterCaptureTalk:[
  ...
  {id:"dell",name:"Dell",map:2,x:3680,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    firstTalk:[
      ...
      {speaker:"Dell",text:"Bind one dusk shard, then go east. The east portal heals you. Leave the extra scout. The hollow is through that gate."}
    ],
    againTalk:[{speaker:"Dell",text:"Still on the later gold, Moon Night. Bind a dusk shard if you haven't, then go east. The east portal heals you."},{speaker:"Dell",text:"One dusk shard is enough to carry. The extra scout can keep the sand."}],
    afterCaptureTalk:[
  ...
  {id:"dell",name:"Dell",map:6,x:4180,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Dell",text:"The animals are the echo. Bind the wyrm, then go east. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"isk",name:"Isk",map:3,x:1820,talkRadius:150,cardId:CINDER_FOX_CARD.id,
    ...
    againTalk:[{speaker:"Isk",text:"Still in the early ash, Moon Night. Bind leftover heat if you haven't, then go east. The east portal heals you."},{speaker:"Isk",text:"The split cairn is east. Press E on it. The animals are the echo."}],
    afterCaptureTalk:[
  ...
  {id:"isk",name:"Isk",map:5,x:1770,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"Reed keeps the fire."},
      {speaker:"Isk",text:"He does. Lynx-shaped coals, not foxes. Don't go into the heart cold."},
      {speaker:"Isk",text:"The animals are the echo. Bind one, then go east. The east gate heals you. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"rowan",name:"Rowan",map:1,x:4730,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    ...
    againTalk:[{speaker:"Rowan",text:"Still on the leftover wall-road, Moon Night. Bind the spark if you haven't, then go east. The east portal heals you."},{speaker:"Rowan",text:"Tamsin is west. Maer is farther east. The dragon still keeps the ruins."}],
    afterCaptureTalk:[
  ...
  {id:"rowan",name:"Rowan",map:6,x:3880,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Rowan",text:"The animals are the echo. Bind the wyrm, then go east. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}
    ],
  ...
  {id:"ryn",name:"Ryn",map:4,x:5565,talkRadius:150,cardId:PALE_STAG_CARD.id,
    firstTalk:[
      {speaker:"Ryn",text:"Last cliff before the kiln. I'm Ryn. I keep this gate so nobody walks in cold."},
      {speaker:"Moon Night",text:"Reed keeps the quiet fire."},
      {speaker:"Ryn",text:"He does. The animals are the echo. Bind the stag, then go east. The east gate heals you."},
      {speaker:"Ryn",text:"Kiln heat is next. Don't go into the heart cold. Reed is through this gate."}
    ],
    againTalk:[{speaker:"Ryn",text:"Still on the last cliff, Moon Night. Bind the stag if you haven't, then go east. The east gate heals you."},{speaker:"Ryn",text:"Reed is through it. Don't go into the heart cold."}],
    afterCaptureTalk:[
      {speaker:"Ryn",text:"You bound the pool shard. The well can dim. The kiln still needs that heat."},
      {speaker:"Ryn",text:"Castle rain, shore dusk, cairn twist — the animals are the echo — then kiln heat and the heart altar."},
      {speaker:"Ryn",text:"The east gate heals you. Talk to Reed, then Kest. Press E at the altar to end the campaign."}
    ],
  ...
  {id:"ryn",name:"Ryn",map:5,x:5300,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"Reed keeps the kiln."},
      {speaker:"Ryn",text:"West of here. Don't go in cold. Kest is through the east gate."},
      {speaker:"Ryn",text:"The animals are the echo. Bind one, then go east. The east gate heals you. Press E at the heart altar. That ends the campaign."}
    ],
    againTalk:[{speaker:"Ryn",text:"We meet again. Cliff wind, then kiln gate. Same watch, later heat."},{speaker:"Ryn",text:"The east gate heals you. Talk to Kest. Press E at the altar. That ends it."}],
    afterCaptureTalk:[
      {speaker:"Ryn",text:"You bound the coal shard. Don't go in cold. The heart still needs that heat."},
      {speaker:"Ryn",text:"Castle rain, shore dusk, cairn twist — the animals are the echo — then this kiln heat. The heart altar is next."},
  ...
  {id:"edan",name:"Edan",map:6,x:4900,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"Kest walked ahead."},
      {speaker:"Edan",text:"The cooled vein is east. The last stone is farther."},
      {speaker:"Edan",text:"The animals are the echo. Bind the wyrm, then go east. The gate behind you still heals. Press E at the heart altar. That ends the campaign."}
    ],
    againTalk:[{speaker:"Edan",text:"Still here. Bind the wyrm, then walk east. Press E at the altar. The campaign ends when the signal rests."},{speaker:"Edan",text:"Animals were the echo the whole road. The altar is where it can stop running."}],
    afterCaptureTalk:[
      {speaker:"Edan",text:"You bound the last pulse. That's every shard, still in one place."},
      {speaker:"Edan",text:"Castle rain, shore dusk, cairn twist — the animals are the echo — kiln heat, then this heart altar."},
