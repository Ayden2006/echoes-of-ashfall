...
const ROAD_STEP_HEIGHT = 56; // leftover maps 1/3 road seams still hold walk/slide; leftover stones keep STEP_HEIGHT; leftover maps 2/4/5/6 walk/slide still hold after #70 road-step; leftover still holds after hunt teleport; leftover still holds after hunthold
...
const NPCS:Npc[] = [
  {id:"reed",name:"Reed",map:5,x:760,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Reed",text:"A banked coal-bed sits east. Press E there if the coals feel thin."},
  ...
  {id:"kest",name:"Kest",map:6,x:920,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Kest",text:"A first-step stone sits east of this heart. Press E there if the pulse feels thin."},
  ...
  {id:"calen",name:"Calen",map:1,x:820,talkRadius:150,cardId:BABY_DRAGON_CARD.id,helm:true,
    firstTalk:[
      ...
      {speaker:"Calen",text:"A rain-worn plaque sits east. Press E there if the rain feels thin."}
    ],
  ...
  {id:"calen",name:"Calen",map:4,x:3180,talkRadius:150,cardId:PALE_STAG_CARD.id,helm:true,
    firstTalk:[
      ...
      {speaker:"Calen",text:"Pale lichen sits west of this watch. Press E there if the wind feels thin."}
    ],
    againTalk:[
  ...
  {id:"sera",name:"Sera",map:2,x:480,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    firstTalk:[
      ...
      {speaker:"Sera",text:"A dusk-shell sits east on a ledge. Press E there if the gold feels thin."}
    ],
  ...
  {id:"sera",name:"Sera",map:5,x:5720,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Sera",text:"Quiet bellows sit west of this later heat. Press E there if the heat feels thin."},
  ...
  {id:"bram",name:"Bram",map:3,x:480,talkRadius:150,cardId:CINDER_FOX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Bram",text:"Bind a fox, then go east. The east portal heals you."},
      {speaker:"Bram",text:"Read the split cairn mid-hollow. Press E there if the stones feel thin."}
    ],
  ...
  {id:"bram",name:"Bram",map:6,x:1480,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Bram",text:"A first-step stone sits east. Press E there if the leftover fire feels thin."},
  ...
  {id:"orrin",name:"Orrin",map:1,x:2280,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Orrin",text:"The plaque higher up copies the same rain. Press E there if the line feels thin."}
    ],
  ...
  {id:"orrin",name:"Orrin",map:4,x:650,talkRadius:150,cardId:PALE_STAG_CARD.id,
    firstTalk:[
      ...
      {speaker:"Orrin",text:"A cliff notch sits east of this copy. Press E there if the wind feels thin."}
    ],
  ...
  {id:"nia",name:"Nia",map:2,x:4360,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    firstTalk:[
      ...
      {speaker:"Nia",text:"A tide-cut step sits east on this last stretch. Press E there if the gold feels thin."}
    ],
  ...
  {id:"nia",name:"Nia",map:6,x:3280,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Nia",text:"A first-step stone sits west. Press E there if the last light feels thin."},
  ...
  {id:"vess",name:"Vess",map:3,x:5140,talkRadius:150,cardId:CINDER_FOX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Vess",text:"The cairn I read still sits west. Press E there if the stones feel thin."}
    ],
  ...
  {id:"vess",name:"Vess",map:5,x:2960,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Vess",text:"Quiet bellows sit west of this kiln road. Press E there if the breath feels thin."},
  ...
  {id:"tamsin",name:"Tamsin",map:1,x:3980,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Tamsin",text:"The merlon still watches east. Press E there if the rain feels thin."}
    ],
  ...
  {id:"tamsin",name:"Tamsin",map:5,x:5000,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Tamsin",text:"Quiet bellows sit west of this wall-road. Press E there if the fire feels thin."},
  ...
  {id:"lira",name:"Lira",map:2,x:2480,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    firstTalk:[
      ...
      {speaker:"Lira",text:"The drowned post mid-beach keeps count. Press E there if the light feels thin."}
    ],
  ...
  {id:"lira",name:"Lira",map:4,x:4480,talkRadius:150,cardId:PALE_STAG_CARD.id,
    firstTalk:[
      ...
      {speaker:"Lira",text:"Pale lichen sits west of this count. Press E there if the light feels thin."}
    ],
  ...
  {id:"holt",name:"Holt",map:3,x:3800,talkRadius:150,cardId:CINDER_FOX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Holt",text:"The cairn still sits west. Press E there if the stones feel thin."}
    ],
  ...
  {id:"holt",name:"Holt",map:6,x:3580,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Holt",text:"A first-step stone sits west. Press E there if the last stones feel thin."},
  ...
  {id:"maer",name:"Maer",map:1,x:5480,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Maer",text:"The merlon still sits east. Press E there if the rain feels thin."}
    ],
  ...
  {id:"maer",name:"Maer",map:5,x:3600,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Maer",text:"Quiet bellows sit west of this leftover rain. Press E there if the fire feels thin."},
  ...
  {id:"perrin",name:"Perrin",map:2,x:4000,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    firstTalk:[
      ...
      {speaker:"Perrin",text:"A tide-cut step sits east of this late sand. Press E there if the shore feels thin."}
    ],
  ...
  {id:"perrin",name:"Perrin",map:5,x:3260,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Perrin",text:"Quiet bellows sit west of these late coals. Press E there if the heat feels thin."},
  ...
  {id:"wren",name:"Wren",map:1,x:1200,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Wren",text:"The plaque higher up still writes. Press E there if the signal feels thin."}
    ],
  ...
  {id:"wren",name:"Wren",map:4,x:5200,talkRadius:150,cardId:PALE_STAG_CARD.id,
    firstTalk:[
      ...
      {speaker:"Wren",text:"Pale lichen sits west of this listen. Press E there if the pool feels thin."}
    ],
  ...
  {id:"dell",name:"Dell",map:2,x:3680,talkRadius:150,cardId:SUNSET_JACKAL_CARD.id,
    firstTalk:[
      ...
      {speaker:"Dell",text:"A tide-cut step sits east of this gold. Press E there if the gold feels thin."}
    ],
  ...
  {id:"dell",name:"Dell",map:6,x:4180,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Dell",text:"A cooled vein sits east. Press E there if the gold feels thin."},
  ...
  {id:"isk",name:"Isk",map:3,x:1820,talkRadius:150,cardId:CINDER_FOX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Isk",text:"The cairn still sits east. Press E there if the ash feels thin."}
    ],
  ...
  {id:"isk",name:"Isk",map:5,x:1770,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Isk",text:"A banked coal-bed sits west of this breath. Press E there if the heat feels thin."},
  ...
  {id:"rowan",name:"Rowan",map:1,x:4730,talkRadius:150,cardId:BABY_DRAGON_CARD.id,
    firstTalk:[
      ...
      {speaker:"Rowan",text:"The merlon still watches this leftover road. Press E there if the rain feels thin."}
    ],
  ...
  {id:"rowan",name:"Rowan",map:6,x:3880,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Rowan",text:"A cooled vein sits east. Press E there if the leftover road feels thin."},
  ...
  {id:"ryn",name:"Ryn",map:4,x:5565,talkRadius:150,cardId:PALE_STAG_CARD.id,
    firstTalk:[
      ...
      {speaker:"Ryn",text:"Pale lichen sits west of this first gate. Press E there if the pool feels thin."}
    ],
  ...
  {id:"ryn",name:"Ryn",map:5,x:5300,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Ryn",text:"Quiet bellows sit west of this first kiln gate. Press E there if the coals feel thin."},
  ...
  {id:"edan",name:"Edan",map:6,x:4900,talkRadius:150,cardId:HEART_WYRM_CARD.id,
    firstTalk:[
      ...
      {speaker:"Moon Night",text:"Kest walked ahead."},
      {speaker:"Edan",text:"He waited west. I keep the last stone. The cooled vein is east. Press E there if the pulse feels thin."},
  ...
  {id:"hale",name:"Hale",map:4,x:4080,talkRadius:150,cardId:PALE_STAG_CARD.id,
    firstTalk:[
      ...
      {speaker:"Hale",text:"Pale lichen sits west of this first watch. Press E there if the wind feels thin."}
    ],
  ...
  {id:"hale",name:"Hale",map:5,x:4040,talkRadius:150,cardId:EMBER_LYNX_CARD.id,
    firstTalk:[
      ...
      {speaker:"Hale",text:"Quiet bellows sit west of this kiln stretch. Press E there if the coals feel thin."},
...
const groundBeastHop = (beast:{id:string;mode:DragonMode;leapStarted:number;leapUntil:number}, now:number)=>{
  ...
  return hopArc(hopT,52); // fox/stag/lynx hop leftover still holds after #61/#66; wyrm keeps roost/fly; leftover still holds after followHold
};
...
const plantedHuntHoldAt=(map:MapId,rawHoldX:number,huntedX:number)=>{
  ...
  return bestInRange??best??plantedFloorAt(map,rawHoldX); // leftover hunt hold still plants after hunt teleport; strike range still holds; leftover stones stay STEP-only; leftover still plants after hunthold
};
...
const keepCreatureOnRoad=(creature:{x:number;y:number;groundY:number},map:MapId)=>{
  ...
  if(ground!==null){
    ...
    if(creature.y>ground)creature.y=ground; // hop/gait leftover still holds after #61/#66; do not flatten fox/stag/lynx air; leftover still holds after followHold
    return ground;
  }
  ...
  if(creature.y>floor.groundY)creature.y=floor.groundY; // hop/gait leftover still holds after #61/#66; do not flatten fox/stag/lynx air; leftover still holds after followHold
...
export default function AshfallGame() {
  ...
  const enterMap = useCallback((map:MapId, from:MapId|null=mapRef.current) => {
    ...
    pl.health=pl.maxHealth;staminaRef.current=MAX_STAMINA;staminaUsedAt.current=-Infinity;setHealth(pl.maxHealth);setStamina(MAX_STAMINA); // portal heal still fires after companion reseat; leftover still fires after #70 groundAt signature; leftover still fires after #72 road-step; leftover still fires after hunt teleport; leftover still fires after hunthold
    const ally=companionRef.current;
    if(ally.active&&ally.itemId){
      ...
      const arrivalGround=seat.groundY; // companion portal reseat still plants after #38 floors; leftover still plants after #70 groundAt signature; leftover still plants after #72 road-step; leftover still plants after hunt teleport; leftover still plants after hunthold
    ...
    portalFlashUntil.current=performance.now()+430; // portal flash still fires after companion reseat; leftover still fires after #70 groundAt signature; leftover still fires after #72 road-step; leftover still fires after hunt teleport; leftover still fires after hunthold
    tone(610,.25,.028);window.setTimeout(()=>tone(360,.2,.02),100); // portal enter tone still fires after companion reseat; leftover still fires after #70 groundAt signature; leftover still fires after #72 road-step; leftover still fires after hunt teleport; leftover still fires after hunthold
  },[showDialogue,tone]);
  ...
  const interact = useCallback(() => {
    ...
    else if(map===6&&atHeartAltar(x)){ // altar E still wins after #56 Dell/Rowan walk-out and #64 afterCapture trim; no nearby talk radius covers this window; leftover still fires after #66 scenery vein move; leftover still fires after hunt teleport; leftover still fires after hunthold
  ...
  useEffect(()=>{
    const down=(e:KeyboardEvent)=>{
      ...
      if(startedRef.current&&/^[1-5]$/.test(k)&&!e.repeat){selectUsableSlot(Number(k)-1);return;} // leftover 1–5 still selects during recall after #63; leftover still selects after hunthold
  ...
  useEffect(()=>{
    ...
    const drawActualAttackArm=(pl:Player,now:number)=>{
      ...
      ctx.imageSmoothingEnabled=false;ctx.shadowColor=late?"rgba(255,246,210,.88)":"rgba(135,62,198,.3)";ctx.shadowBlur=late?12:7; // LMB sword rim stays readable on maps 5–6 after #48/#50 late stroke; leftover still readable after #70 road-step; leftover still readable after hunt teleport; leftover still readable after hunthold
    ...
    const updateCompanion=(dt:number,now:number)=>{
      ...
      if(ally.map!==map){
        ...
        const seat=plantedFloorAt(map,pl.x-pl.facing*96);
        ally.x=creatureEdgeAt(map,seat.x);
        const reseatGround=seat.groundY; // companion portal reseat still plants after #38 floors; leftover still plants after #70 groundAt signature; leftover still plants after #72 road-step; leftover still plants after hunt teleport; leftover still plants after hunthold
      ...
      const followHold=!hunting?plantedFloorAt(map,followX):null; // leftover follow still plants after #72 road-step; close leftover stones stay off allies; leftover still plants after followHold; hunt path still uses hunted.x; leftover still plants after hunt teleport; leftover still plants after hunthold
      ...
      if(Math.abs(pl.x-ally.x)>COMPANION_TELEPORT_DISTANCE&&!stayForHunt){
        const seat=followHold??plantedFloorAt(map,followX); // leftover teleport still plants after followHold; hunt path still uses hunted.x; leftover still plants after hunt teleport; leftover still plants after hunthold
      ...
      const huntHold=hunting?plantedHuntHoldAt(map,rawHoldX,targetX):null; // leftover hunt hold still plants after hunt teleport; strike range still holds; leftover stones stay STEP-only; leftover still plants after hunthold
      ...
      if(distance>46){
        ...
        const idleSeat=!hunting?plantedFloorAt(map,ally.x):null; // leftover idle still plants after #72 road-step; close leftover stones stay STEP-only; leftover idle still plants after followHold; leftover still clears thin stones after hunthold
        ...
        ally.y+=(ally.groundY-leftover-ally.y)*(1-Math.exp(-12*dt)); // hop/roost leftover still eases through idle after sleep→wake and portal reseat; leftover still plants after #72 road-step; leftover still plants after followHold; leftover still plants after hunthold
    ...
    const drawHuntMark=(x:number,y:number,now:number,marked:boolean)=>{
      ...
      ctx.lineWidth=late?4:3;ctx.strokeStyle=late?"rgba(6,2,4,.96)":"rgba(4,10,6,.9)";ctx.strokeText("HUNT",0,-10); // leftover HUNT still readable after #70 road-step; leftover still readable after followHold; leftover still readable after hunt teleport; leftover still readable after hunthold
    ...
    const drawLateStudyableTag=(x:number,y:number,label:string)=>{
      ...
      drawCardPressE(x,y+3); // late studyable PRESS E still uses #48/#50/#58 cream stroke for kiln/coal/bellows/echo/vein/step; leftover still matches #52/#61/#68 after followHold
      ctx.restore();
    };
    const drawMagicalAnimalCard=(name:string,x:number,groundY:number,now:number,formedAt:number,image:HTMLImageElement|null,portrait:{x:number;y:number;w:number;h:number}|null,palette:CardPalette)=>{
      ...
      if(elapsed<1700){
        ...
        ctx.fillStyle=late?"#fff6d2":"#eaff9f";ctx.fillText("MAGICAL CARD FORMED",x,riseY-cardH/2*scale-13); // late-map card banner keeps #48/#50/#58 cream stroke; leftover still readable after #70 road-step
      }
    ...
    const drawPortal=(x:number,groundY:number,now:number,map:MapId,colorOverride?:string,label?:string)=>{
      ...
      if(label){
        ...
        ctx.fillStyle="#fff6d2";ctx.fillText(label,cx,groundY-188); // early-map west/east tags keep cream fill after #48/#50 late stroke; maps 2–4 leftover cream still matches #52/#61/#66 late portal tags; leftover still matches #52/#61/#68 after followHold
        ctx.font="900 8px ui-monospace, SFMono-Regular, Menlo, monospace";
        ctx.lineWidth=late?5:4;ctx.strokeStyle=late?"rgba(6,2,4,.96)":"rgba(6,8,10,.88)";
        ctx.strokeText("PRESS E",cx,groundY-174); // maps 5–6 entry/exit keep #52 cream fill + late stroke with nearPortalAt; maps 2–4 leftover PRESS E keeps the same cream; leftover still matches #52/#61/#68 after followHold
    ...
    const frame=(now:number)=>{
      ...
      if(startedRef.current&&!dialogueRef.current&&!inventoryOpenRef.current&&!worldMapOpenRef.current&&playerRespawnAt===0){
        ...
        if(wantsSlide&&pl.grounded&&Math.abs(pl.vx)>55){ // S crouch/slide leftover still readable after road-seam hold; leftover still holds after hunthold
        ...
        if(jump&&pl.jumpsLeft>0){
          ...
          pl.vy=secondJump?-465:-500;pl.grounded=false;pl.jumpsLeft-=1;pl.crouched=false;pl.sliding=false;slideUntil.current=0;didJump=true; // Space jump/double jump leftover still readable after road-seam hold; leftover still holds after hunthold
        ...
        if(item?.type==="animal-card"){
          if(ally.active&&ally.itemId===item.id){
            if(ally.recallStarted===0){const direction:1|-1=ally.x>=pl.x?1:-1;ally.recallStarted=now;ally.attackUntil=0;ally.vx=0;companionCastRef.current={started:now,kind:"recall",direction};pl.facing=direction;tone(470,.16,.022);window.setTimeout(()=>tone(280,.22,.024),180);window.setTimeout(()=>tone(135,.34,.022),610);}
              ...
              const summonFloor=plantedFloorAt(map,summonX); // Tab/1–5/Q deploy still plants off leftover stones after portal reseat; Q-during-recall leftover after #63 still clears thin stones; leftover still clears close leftover stones after #72 road-step; leftover still clears thin stones after hunthold
            ...
            const summonX=creatureEdgeAt(map,pl.x+pl.facing*COMPANION_DEPLOY_DISTANCE);
            const summonFloor=plantedFloorAt(map,summonX); // Tab/1–5/Q deploy still plants off leftover stones after portal reseat; leftover 1–5/Q after #63 still clears thin stones; leftover still clears close leftover stones after #72 road-step; leftover still clears thin stones after hunthold
            const summonGround=companionSurfaceAt(summonFloor.x,pl.y+PH,map)??surfaceYAt(map,summonFloor.x,pl.y+PH)??summonFloor.groundY;
