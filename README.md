...
- Map 5 — The Quiet Ember (kiln terrace): Ember Lynx; Reed talks if you press `E`; Isk can be met again on the early coals; Vess, Perrin, and Maer can be met again on the mid coals; Tamsin can be met again on the later coals; Ryn can be met again before the east gate; Sera can be met again near the east gate; the quiet kiln, a banked coal-bed, and quiet bellows can be studied with `E`
