...
Named travelers and knights stand on the road and talk if you press `E` — the same talk used by Reed and Kest. First words, a later talk, and talk after you bind that map's animal all change. Early and mid-road first talks quietly teach the same three beats: the animals are the echo, bind then go east, and portals heal. Map 1 keeps that teaching short and does not dump the heart-altar ending. After-capture lines treat bound animals as echo shards, not quarry. Late-map first talks name the now-actions: bind the local beast if you still need it, the east gate heals, and pressing `E` at the heart altar ends the campaign — without saying you are stuck if you skipped a mid-road bind. Meet someone again farther east and a later talk is one short beat of the last crossing — castle rain, shore dusk, cairn twist, or kiln — without repeating that finish dump. This is not a dating sim: there are no bond meters, romance choices, or extra relationship systems.
