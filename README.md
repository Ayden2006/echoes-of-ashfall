...
- Map 1 — The Signal in the Rain (moonlit castle): Baby Dragon and an eastern roostling; Calen and Orrin talk if you press `E`; a high rain-worn plaque and a rain-cut groove can be studied with `E`
...
- Map 5 — The Quiet Ember (kiln terrace): Ember Lynx; Reed talks if you press `E`; Vess can be met again by the kiln road; Sera can be met again; the quiet kiln, a banked coal-bed, and quiet bellows can be studied with `E`
